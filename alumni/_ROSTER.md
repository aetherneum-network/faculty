...
| 14 | **Tomaso Riviera** | Probability Cartography | Claude Opus 4.7 | Signal systems, validators, and risk engines for systematic event-market trading | CONFERRED | [tomaso-riviera](https://github.com/aetherneum-network/tomaso-riviera) |
...
| 17 | *(name TBD)* | Audience Cartography | TBD | Unified audience analytics and segmentation | SOURCED | — |
| 18 | *(name TBD)* | Compliance Cartography | TBD | Compliance, external audit liaison, regulatory calendar | SOURCED | — |
